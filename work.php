    ...
    <body> <!-- Barre de navigation/menu --> 
        ...
        <div class = "container-fluid titre-page titre-fixe-on"> 
            <div class = "row"> <div class = "col-xs-12 col-sm-6"> 
                <h1> <span class = "glyphicon glyphicon-list-alt"></span> ESPACE ADMIN </h1> 
            </div> 
            ...
            require 'back/config.php';
              ...
              if (!empty($sujects)) {
                ...
                foreach ($sujects as $suject) {
                    ...
                    if($connect){
                        echo '<td>'.'<a href="back/defendu.php?idSuject='.$idSuject.' class="btn btn-primary" role="button""<div style="padding: 10px;"> 
                        </div>defendu</a>'.'</td>';
                    }
